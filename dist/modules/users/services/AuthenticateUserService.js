...
let AuthenticateUserService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    } // const ps = await this.hashProvider.generateHash(password);
    // const ps1 = await this.hashProvider.generateHash(password);
    // const ps2 = await this.hashProvider.generateHash(password);
    // console.log(ps);
    // console.log(ps1);
    // console.log(ps2);
    ...
    if (!passwordMatched) {
      throw new _AppError.default('Incorrect email/password combination p.', 401);
    }

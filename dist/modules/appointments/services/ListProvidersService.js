...
let ListProvidersService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    let user = await this.cacheProvider.recover(`providers-list:${user_id}`); // user = null;
    ...
    if (!user || true) {
      ...
      await this.cacheProvider.save(`providers-list:${user_id}`, (0, _classTransformer.classToClass)(user));
    }
